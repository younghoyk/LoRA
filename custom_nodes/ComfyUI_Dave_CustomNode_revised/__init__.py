...
import sys
# import filecmp  # No longer needed
# import shutil    # No longer needed

# import __main__  # No longer needed

python = sys.executable


# Old method - no longer needed with WEB_DIRECTORY
# extentions_folder = os.path.join(os.path.dirname(os.path.realpath(__main__.__file__)),
#                                  "web" + os.sep + "extensions" + os.sep + "ComfyUI_Dave_CustomNode")
# javascript_folder = os.path.join(os.path.dirname(os.path.realpath(__file__)), "javascript")
#
# if not os.path.exists(extentions_folder):
#     print('Making the "web\extensions\ComfyUI_Dave_CustomNode" folder')
...
# Add WEB_DIRECTORY for ComfyUI to automatically register the javascript folder
